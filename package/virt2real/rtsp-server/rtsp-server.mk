...
define RTSP_SERVER_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -m 0755 $(BR2_EXTERNAL)/package/virt2real/rtsp-server/rtsp_server.sh $(TARGET_DIR)/etc/virt2real/rtsp_server.sh
	$(INSTALL) -m 0755 $(BR2_EXTERNAL)/package/virt2real/rtsp-server/S92rtspserver $(TARGET_DIR)/etc/init.d.sample/S92rtspserver
endef
