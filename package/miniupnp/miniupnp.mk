...
define MINIUPNP_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -m 755 -D $(BR2_EXTERNAL)/package/miniupnp/S55ssdpd $(TARGET_DIR)/etc/init.d.sample/S55ssdpd
	$(INSTALL) -m 755 -D $(BR2_EXTERNAL)/package/miniupnp/S80upnpd $(TARGET_DIR)/etc/init.d.sample/S80upnpd

	$(INSTALL) -m 0755 -D $(@D)/miniupnpd/miniupnpd $(TARGET_DIR)/usr/bin/miniupnpd
	$(INSTALL) -m 0644 -D $(BR2_EXTERNAL)/package/miniupnp/miniupnpd.conf $(TARGET_DIR)/etc/miniupnpd.conf
	$(INSTALL) -m 0755 -D $(BR2_EXTERNAL)/package/miniupnp/upnpd_prepare.sh $(TARGET_DIR)/etc/virt2real/upnpd_prepare.sh
	$(INSTALL) -m 0755 -D $(BR2_EXTERNAL)/package/busybox/udhcpc.script $(TARGET_DIR)/usr/share/udhcpc/default.script
